...
<main class="app-shell">
    ...
    <section id="review-screen" class="screen hidden">
        ...
        <button id="skip-btn" class="secondary" type="button">Reveal the verdict now</button>
    </section>
    ...
    <section id="verdict-screen" class="screen hidden">
        <div class="verdict-card">
            ...
            <div class="verdict-copy">
                ...
                <p>
                    You are not someone I want to control or hold against your will.
                    You are the person I freely choose with all my heart—and the person
                    I hope will continue choosing me too.
                </p>
                <p>
                ...
                <p>
                    ...
                    Not because of distance. Not because of one difficult moment.
                </p>
                <p>
            ...
            <p>Appeals require one extremely long hug and no fewer than three kisses. 😘</p>
...
function runReview() {
    ...
    reviewTimers.push(setTimeout(showVerdict, scanMessages.length * 720 + 5700));
}
...
document.getElementById("skip-btn").addEventListener("click", showVerdict);
